...
<script type="text/javascript">
   ...
   function add_menu(){
      ...
      htmlStr = htmlStr + '<input type="text" name="price" id="input" style="width: 160px;" placeholder="메뉴 가격을 입력하세요">';
	...
	<div style="width: 1920px;">
		...
		<div style="margin-left: 450px;">
			<form action="./addCtr.do" method="post"
				...
				<div
					style="width: 1050px; height: 500px; padding: 20px; border: 1px solid black;">

					<div
						style="width: 600px; height: 480px; border: 1px solid black; float: left; position: relative;">
						<div id="fileContent"
							style="left: 10px; bottom: 10px; font-size: 1.0em; font-weight: bold; position: absolute;">
					...
					<div
						...
						<ul>
							<li><input type="text" class="restaurantTopInput"
								name='restaurantName' placeholder="맛집명을 입력하세요">
						</ul>
						<ul>
							<li><select class="restaurantTopInput" name='category'>
						...
						<ul>
							<li><input type="text" class="restaurantTopInput"
								name='phone' placeholder="연락처를 입력하세요">
						</ul>
						<ul>
							<li><select class="" name='operatingTime'>
							...
							</select> <span class=""> - </span> <select class="" name='closingTime'>
									<option value="오전 12:00">오전 12:00</option>
									<option value="오전 12:30">오전 12:30</option>
									<option value="오전 01:00">오전 01:00</option>
									<option value="오전 01:30">오전 01:30</option>
						...
						<ul>
							<li><textarea
									...
									name="address" placeholder="주소를 입력하세요"></textarea>
						</ul>
					</div>
					<ul>
				...
				<div
					...
					<textarea
						...
						name="contents" placeholder="맛집소개를 해주세요"></textarea>

					<div>
						<span style="font-size: 30px; font-weight: bold;">메뉴</span> <input
							type="button"
							style="width: 45px; height: 40px; margin-left: -5px; margin-bottom: 7px; vertical-align: middle;"
				...
				<div style="width: 1095px; text-align: center; margin-top: 20px;">
					<input type="button" value="등록취소" class="restaurantInput"
						onclick="moveToListFnc(${restaurantsVo.restaurantNo});"> <input
						type="submit" value="등록완료" class="restaurantInput"
