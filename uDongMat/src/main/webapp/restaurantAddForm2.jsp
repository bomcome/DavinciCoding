...
<div style="width: 1920px;">
	...
	<div style="margin-left: 450px;">
		...
		<div style="width:1050px; height: auto; padding: 20px; border: 1px solid black; margin-top:20px;">
			<span style="font-size: 30px; font-weight: bold;">맛집소개</span>
			<textarea style="width: 1030px; height: 200px; resize: none; margin-top: 10px;" name="contents" placeholder="맛집소개를 해주세요"></textarea>
			...
			<div id="field" style="width: 1050px; height: auto;"></div>
